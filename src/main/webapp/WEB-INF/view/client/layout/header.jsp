      ...
      <div class="top-info ps-2">
        <small class="me-3"
          ...
          <a href="#" class="text-white"
            >137/2 Trần Bá Giao, Phường 5, Gò Vấp, TP HCM</a
          ></small
        >
        <small class="me-3">
          <i class="fas fa-envelope me-2 text-secondary"></i>
          <a href="mailto:nvminh162@gmail.com" class="text-white"
            >nvminh162@gmail.com</a
          >
        </small>
        >
      </div>
  ...
  <div class="container px-0">
    <nav class="navbar navbar-light bg-white navbar-expand-xl">
      <a href="/" class="navbar-brand"
        ><h1 class="text-primary display-6">PaulShop</h1></a
      >
      <button
      ...
      <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
        <div class="navbar-nav mx-auto">
          ...
          <a href="/product/1" class="nav-item nav-link">Product</a> -->
        </div>
